...
const SALARY_INSIGHTS = {
  software: {
    junior:  {
      range: '$65,000–$90,000',
      inr_range: '₹4,00,000–₹8,00,000',
      desc: 'Entry-level SWE roles at startups or mid-size companies',
      inr_desc: 'Entry-level SWE at Indian startups, IT services (TCS, Infosys, Wipro), or product companies',
    },
    mid:     {
      range: '$90,000–$130,000',
      inr_range: '₹8,00,000–₹15,00,000',
      desc: '2–5 years experience, strong individual contributor',
      inr_desc: '2–5 yrs exp, product companies (Flipkart, Swiggy, Meesho) or mid-size tech firms',
    },
    senior:  {
      range: '$130,000–$175,000',
      inr_range: '₹15,00,000–₹40,00,000',
      desc: '5+ years, tech lead capability, mentoring others',
      inr_desc: '5+ yrs, senior SWE at FAANG India, Zepto, PhonePe, or top product companies',
    },
    lead:    {
      range: '$160,000–$220,000',
      inr_range: '₹40,00,000–₹1,00,00,000+',
      desc: 'Staff/Principal level, cross-team technical leadership',
      inr_desc: 'Staff/Principal at Google, Microsoft, Amazon India or unicorn startups',
    },
  },
  data: {
    junior:  {
      range: '$70,000–$95,000',
      inr_range: '₹4,00,000–₹8,00,000',
      desc: 'Data analyst to junior data scientist track',
      inr_desc: 'Data analyst or junior DS at analytics firms, IT companies, or e-commerce startups',
    },
    mid:     {
      range: '$95,000–$135,000',
      inr_range: '₹8,00,000–₹15,00,000',
      desc: 'Independent DS with shipping models to production',
      inr_desc: 'Data scientist at fintech, edtech, or product companies — owning ML pipelines',
    },
    senior:  {
      range: '$140,000–$190,000',
      inr_range: '₹15,00,000–₹40,00,000',
      desc: 'Senior DS/MLE owning ML platform or key initiatives',
      inr_desc: 'Senior DS/MLE at FAANG India, Razorpay, CRED, or top analytics firms',
    },
    lead:    {
      range: '$175,000–$230,000',
      inr_range: '₹40,00,000–₹80,00,000+',
      desc: 'Staff MLE or Principal DS with org-wide impact',
      inr_desc: 'Principal DS, Head of AI/ML at large product companies or unicorns',
    },
  },
  product: {
    junior:  {
      ...
      inr_range: '₹4,00,000–₹8,00,000',
      desc: 'APM or junior PM at startup or larger company',
      inr_desc: 'APM at early-stage startup or IT company — building foundational PM skills',
    },
    mid:     {
      range: '$100,000–$140,000',
      inr_range: '₹8,00,000–₹15,00,000',
      desc: 'PM owning a product or major feature area',
      inr_desc: 'PM at Zomato, Ola, Paytm, or funded startups owning a product area',
    },
    senior:  {
      range: '$145,000–$195,000',
      inr_range: '₹15,00,000–₹35,00,000',
      desc: 'Senior PM owning a line of business',
      inr_desc: 'Senior PM at FAANG India, unicorn startups, or large product companies',
    },
    lead:    {
      range: '$180,000–$250,000',
      inr_range: '₹35,00,000–₹80,00,000+',
      desc: 'Director of PM or Group PM with team leadership',
      inr_desc: 'Group PM, Director of Product at top Indian product companies or global MNCs',
    },
  },
  design: {
    junior:  {
      range: '$60,000–$82,000',
      inr_range: '₹3,50,000–₹7,00,000',
      desc: 'Junior designer at agency or startup',
      inr_desc: 'Junior UI/UX designer at agencies, IT firms, or early-stage startups in India',
    },
    mid:     {
      range: '$85,000–$120,000',
      inr_range: '₹7,00,000–₹15,00,000',
      desc: 'Mid-level UX/Product designer, owns features',
      inr_desc: 'Product designer at funded startups, design studios, or mid-size tech companies',
    },
    senior:  {
      range: '$120,000–$165,000',
      inr_range: '₹15,00,000–₹30,00,000',
      desc: 'Senior designer, design system contributor',
      inr_desc: 'Senior UX/Product designer at FAANG India, Flipkart, or top-tier product companies',
    },
    lead:    {
      range: '$155,000–$210,000',
      inr_range: '₹30,00,000–₹60,00,000+',
      desc: 'Principal designer or Design Manager',
      inr_desc: 'Design lead, Head of Design at unicorn or large product org',
    },
  },
  devops: {
    junior:  {
      range: '$75,000–$100,000',
      inr_range: '₹4,00,000–₹8,00,000',
      desc: 'Junior DevOps/Cloud engineer',
      inr_desc: 'Junior DevOps/Cloud engineer at IT services or early-stage tech companies',
    },
    mid:     {
      range: '$100,000–$145,000',
      inr_range: '₹8,00,000–₹15,00,000',
      desc: 'Cloud/DevOps engineer owning infrastructure',
      inr_desc: 'DevOps/SRE at product companies — managing CI/CD, Kubernetes, AWS/GCP infra',
    },
    senior:  {
      range: '$145,000–$195,000',
      inr_range: '₹15,00,000–₹35,00,000',
      desc: 'Senior SRE or Platform engineer',
      inr_desc: 'Senior SRE/Platform engineer at FAANG India, fintech, or cloud-first companies',
    },
    lead:    {
      range: '$175,000–$240,000',
      inr_range: '₹35,00,000–₹80,00,000+',
      desc: 'Staff/Principal SRE or Engineering Manager',
      inr_desc: 'Staff SRE, Head of Infrastructure or Engineering Manager at large product firms',
    },
  },
  marketing: {
    junior:  {
      range: '$50,000–$72,000',
      inr_range: '₹3,00,000–₹6,00,000',
      desc: 'Coordinator or specialist in digital marketing',
      inr_desc: 'Digital marketing executive or SEO/SEM specialist at startups or agencies',
    },
    mid:     {
      range: '$72,000–$105,000',
      inr_range: '₹6,00,000–₹12,00,000',
      desc: 'Marketing manager owning channels or campaigns',
      inr_desc: 'Marketing manager at D2C brands, edtech, or funded startups owning growth channels',
    },
    senior:  {
      range: '$105,000–$150,000',
      inr_range: '₹12,00,000–₹25,00,000',
      desc: 'Senior/Director-level marketing leader',
      inr_desc: 'Marketing director or Head of Growth at mid-to-large companies or unicorns',
    },
    lead:    {
      range: '$145,000–$200,000',
      inr_range: '₹25,00,000–₹60,00,000+',
      desc: 'VP Marketing or CMO at growth-stage company',
      inr_desc: 'VP Marketing or CMO at unicorn startups or large Indian conglomerates',
    },
  },
  finance: {
    junior:  {
      range: '$60,000–$85,000',
      inr_range: '₹3,50,000–₹7,00,000',
      desc: 'Financial analyst or junior accountant',
      inr_desc: 'Financial analyst at Big 4 firms (Deloitte, PwC, EY, KPMG) or banks in India',
    },
    mid:     {
      range: '$85,000–$125,000',
      inr_range: '₹7,00,000–₹15,00,000',
      desc: 'Senior analyst or manager in finance',
      inr_desc: 'Finance manager at corporate firms, NBFCs, or fintech companies',
    },
    senior:  {
      range: '$125,000–$175,000',
      inr_range: '₹15,00,000–₹30,00,000',
      desc: 'Director of Finance or Controller',
      inr_desc: 'Finance director, Controller at large corporates or multinational companies in India',
    },
    lead:    {
      range: '$170,000–$250,000',
      inr_range: '₹30,00,000–₹80,00,000+',
      desc: 'VP Finance or CFO at mid-to-large company',
      inr_desc: 'CFO or VP Finance at unicorn startups, large conglomerates, or listed companies',
    },
  },
  general: {
    junior:  {
      range: '$50,000–$72,000',
      inr_range: '₹3,50,000–₹7,00,000',
      desc: 'Entry-level professional role',
      inr_desc: 'Entry-level role at IT services, startups, or corporate companies in India',
    },
    mid:     {
      range: '$72,000–$105,000',
      inr_range: '₹7,00,000–₹15,00,000',
      desc: 'Mid-level individual contributor',
      inr_desc: 'Mid-level professional at product or services companies in India',
    },
    senior:  {
      range: '$105,000–$145,000',
      inr_range: '₹15,00,000–₹30,00,000',
      desc: 'Senior professional with team influence',
      inr_desc: 'Senior professional at top Indian companies, MNCs, or funded startups',
    },
    lead:    {
      range: '$140,000–$190,000',
      inr_range: '₹30,00,000–₹70,00,000+',
      desc: 'Manager or senior lead with team ownership',
      inr_desc: 'Manager or senior lead at large product companies, unicorns, or MNCs in India',
    },
  },
};
